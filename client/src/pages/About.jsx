  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-20">
        <div className="border py-8 sm:py-16 px-10 md:px-16 gap-5 text-[15px] hover:bg-indigo-600 hover:text-white transition-all duration-300 cursor-pointer text-gray-600">
          <b>Efficiency</b>
